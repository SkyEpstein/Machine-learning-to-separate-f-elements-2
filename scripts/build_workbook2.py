...
sheet("Audit corrections",
    ...
    ["Top-10 percent confidence R2", "selective-prediction operating point", "0.912 / 0.940 / 0.776", "Report the RMSE drop; the R2 rise is partly the shrinking variance of the retained subset. The Track B 0.940 was on a leaky split; recomputed on the condition-key split it is 0.874 (RMSE 0.430), with all-rows R2 0.611."],
